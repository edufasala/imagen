...
const useStyles = makeStyles((theme) => ({
  ...
  appLogoLightPreviewImg: {
    width: "100%",
    maxHeight: 72,
    content: "url(" + ((theme.appLogoLight || theme.appLogoDark) ? process.env.REACT_APP_BACKEND_URL+"/public/"+ (theme.appLogoLight || theme.appLogoDark) : logo ) + ")"
  },
  
  appLogoDarkPreviewImg: {
    width: "100%",
    maxHeight: 72,
    content: "url(" + ((theme.appLogoLight || theme.appLogoDark) ? process.env.REACT_APP_BACKEND_URL+"/public/"+ (theme.appLogoDark || theme.appLogoLight) : logoDark ) + ")"
  },
  ...
  appLogoFaviconPreviewImg: {
    width: "100%",
    maxHeight: 72,
    content: "url(" + ((theme.appLogoFavicon) ? process.env.REACT_APP_BACKEND_URL+"/public/" + theme.appLogoFavicon : logoFavicon ) + ")"
  }
}));
